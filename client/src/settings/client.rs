...
impl SettingsGenerator for ClientSettings {
        ...
        Self: Sized,
    {
        ...
        Ok(Self {
            ...
            format_json: extract_from_map(data, "format-json", false)?,
...
pub fn client_settings_builder() -> SettingsBuilder {
    ...
    SettingsBuilder::new()
        ...
        .group(
            ...
            vec![
                SettingSchemaBuilder::new("http")
                    .unwrap()
                    .help("Flag to activate HTTP server")
                    .with_default(false.to_string())
                    .param_type(ParamType::Flag)
                    .build(),
                SettingSchemaBuilder::new("format-json")
                    .unwrap()
                    .param_type(ParamType::Flag)
                    .help("Format every JSON response generated by the client REST API")
                    .build(),
            ],
        )
        .unwrap()
