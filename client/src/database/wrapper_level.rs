...
{
    pub fn deserialize(bytes: Vec<u8>) -> Result<V, error::WrapperLevelDBErrors> {
    ...
    pub fn serialize(value: V) -> Result<Vec<u8>, error::WrapperLevelDBErrors> {
    ...
    V: Serialize + DeserializeOwned,
{
    ...
    pub fn create_last_key(&self) -> String {
    ...
    pub fn get_read_options(&self) -> options::ReadOptions<StringKey> {
    ...
    pub fn get_count(&self) -> usize {
        let iter = self.db.keys_iter(self.get_read_options());
